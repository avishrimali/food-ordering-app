...
This project is created by us as a group project for food order application for which we have submitted the backend code, this will be integrated with the backend code. 
